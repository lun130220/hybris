...
public class ConcertModel extends VariantProductModel
{
	...
	/** <i>Generated variable</i> - Variable of <code>Concert.venue</code> attribute defined at extension <code>concerttours</code>. */
	private String _venue;
	
	/** <i>Generated variable</i> - Variable of <code>Concert.date</code> attribute defined at extension <code>concerttours</code>. */
	private Date _date;
	
	/** <i>Generated variable</i> - Variable of <code>Concert.concertType</code> attribute defined at extension <code>concerttours</code>. */
	private ConcertType _concertType;
	...
	{
		if (this._concertType!=null)
		{
			return _concertType;
		}
		return _concertType = getPersistenceContext().getValue(CONCERTTYPE, _concertType);
	}
	...
	public String getVenue()
	{
		...
		return _venue = getPersistenceContext().getValue(VENUE, _venue);
	}
	...
	{
		_concertType = getPersistenceContext().setValue(CONCERTTYPE, value);
	}
	...
	{
		_venue = getPersistenceContext().setValue(VENUE, value);
	}
